...
;------------------------------------------------------------
;tl0                       Allocated with name '_Timer0_Delay_PARM_2'
;th0                       Allocated to registers r7 
;------------------------------------------------------------
;	../lib/mcs-51.c:4: void Timer0_Delay(unsigned char th0, unsigned char tl0)
;	-----------------------------------------
...
;	../lib/mcs-51.c:7: TL0 = tl0;    // Load value for TL0 register
	mov	_TL0,_Timer0_Delay_PARM_2
;	../lib/mcs-51.c:8: TH0 = th0;    // Load value for TH0 register
	mov	_TH0,r7
;	../lib/mcs-51.c:9: TR0 = 0xff;   // Run Timer-0
;	assignBit
	setb	_TR0
;	../lib/mcs-51.c:11: while(!TF0);  // Poll TF0  
00101$:
	jnb	_TF0,00101$
;	../lib/mcs-51.c:13: TR0 = 0x00;   // If TF0=1 stop the timer by making TR0=0
;	assignBit
	clr	_TR0
;	../lib/mcs-51.c:14: TF0 = 0x00;   // If TF0=1 stop the timer by making TR0=0
;	assignBit
	clr	_TF0
;	../lib/mcs-51.c:15: }
	ret
...
;------------------------------------------------------------
;	../lib/mcs-51.c:17: void mcs51_mult_max_timer0_delay(const int mult)
;	-----------------------------------------
...
00101$:
	...
	subb	a,b
	jnc	00104$
;	../lib/mcs-51.c:22: Timer0_Delay(0x00, 0x00);
	mov	_Timer0_Delay_PARM_2,#0x00
	mov	dpl,#0x00
	push	ar7
	push	ar6
	lcall	_Timer0_Delay
